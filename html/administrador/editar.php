    ...
    <article class="content">
        ...
        <div class="contenido">
            <form action="" method="POST">
                ...
                <a class="btn a_edit_u" name="cancelar" href="../administrador/usuarios.php">Cancelar</a>
                ...
                <?php
                    ...
                    if($actualizar=="ok"){
                        ...
                        echo '<div class="alert alert-success" style="position:relative;top:-50px;">El usuario a sido actualizado<div>';
