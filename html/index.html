                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>Cena con <span class="typer" id="some-id" data-delay="180" data-delim=":" data-words="TUS AMIGOS: TU FAMILIA" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
                            <br></br>
                            <h2>EN EL MEJOR RESTAURANTE DE LA CIUDAD</h2>
                            <p>Todas las combinaciones que te puedes imaginar</p>
                            <div class="book-btn">
                                <ul>
                                    <li class="button_user">
                                        <a class="buttonLogin hvr-underline-from-center active" href="#">Login</a>
                                        <a class="button hvr-underline-from-center" href="#">Register</a>
                                    </li>
                                </ul>
                            </div>
                            <a href="#about">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title"> Qui&eacute;nes Somos </h2>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-main p_img" src="../upload/plato_3.jpg" alt="About plato_3 image">
                            <img class="about-inset" src="../upload/plato_1.jpg" alt="About plato_4 image">
                        </div>
                    </div>
                </div>
                <!-- end col -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span><a href="#">brando@es.uazuay.edu.ec</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
